...
function build_page_info(result) {
	...
	$("#page_info_area").append(
			"当前第" + emps.pageNum + "页,总" + emps.pages + "页,总共有" + emps.total
					+ "条记录");
	totolRecord = emps.total;
...
function validate_add_form() {
	...
	// 2.正则表达式
	var regName = /(^[A-Za-z0-9]{3,10}$)|(^[\u2E80-\u9FFF]{2,5}$)/;
